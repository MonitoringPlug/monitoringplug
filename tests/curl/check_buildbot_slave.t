...
test_expect_success 'check_buildbot_slave' "
    test_expect_code 2 $BASE/curl/check_buildbot_slave -H test.mp.durchmesser.ch \
        --port 80 --subpath /buildbot
"

test_expect_success 'check_buildbot_slave w/ online slave' "
    $BASE/curl/check_buildbot_slave -H test.mp.durchmesser.ch \
...
test_expect_success 'Rabbit w\ garbage input' "
    test_expect_code 2 $BASE/curl/check_buildbot_slave -H test.mp.durchmesser.ch --port 80 --subpath /garbage
"

test_expect_success 'Rabbit w\ garbage json input' "
    test_expect_code 2 $BASE/curl/check_buildbot_slave -H test.mp.durchmesser.ch --port 80 --subpath /garbage/json
"
