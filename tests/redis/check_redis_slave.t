...
test_description='Test check_redis_slave'
...
test_expect_success 'check_redis_slave' "
    $WRAPPER $BASE/redis/check_redis_slave -P 8888
"

test_expect_success 'check_redis_slave wrong port' "
    test_expect_code 2 $WRAPPER $BASE/redis/check_redis_slave -P 7778
"

test_expect_success 'check_redis_slave unixsocket' "
    $WRAPPER $BASE/redis/check_redis_slave -s redis_slave.sock
"

test_expect_success 'check_redis_slave unixsocket unknown file' "
    test_expect_code 2 $WRAPPER $BASE/redis/check_redis_slave redis.sock2
"

test_expect_success 'check_redis_slave unixsocket file' "
    test_expect_code 2 $WRAPPER $BASE/redis/check_redis_slave redis.sock3
"

test_expect_success 'check_redis_slave connect to master' "
...
test_expect_success 'check_redis_slave w/ master shutdown' "
