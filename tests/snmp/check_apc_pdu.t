...
test_description='Test check_apc_pdu'

. ../sharness.sh

test_expect_success 'check_apc_pdu' "
    test_expect_code 0 $BASE/snmp/check_apc_pdu -H test.mp.durchmesser.ch -P 1661\
        -C apc_pdu
"

test_expect_success 'check_akcp w/ unknown sensor' "
    test_expect_code 3 $BASE/snmp/check_apc_pdu -H test.mp.durchmesser.ch -P 1661\
        -C apc_pdu --on 9
"

test_expect_success 'check_akcp w/ sensor in wrong state' "
