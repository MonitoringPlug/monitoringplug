...
test_description='Test check_keepalived_vrrp'

. ../sharness.sh

test_expect_success 'check_check_keepalived_vrrp' "
    test_expect_code 0 $BASE/snmp/check_keepalived_vrrp -H test.mp.durchmesser.ch -P 1661 \
        -C keepalived_vrrp_master
"

test_expect_success 'check_check_keepalived_vrrp w/ master instance' "
    test_expect_code 0 $BASE/snmp/check_keepalived_vrrp -H test.mp.durchmesser.ch -P 1661 \
        -C keepalived_vrrp_master --instance staginglb
"

test_expect_success 'check_check_keepalived_vrrp w/ slave instance' "
    test_expect_code 0 $BASE/snmp/check_keepalived_vrrp -H test.mp.durchmesser.ch -P 1661 \
        -C keepalived_vrrp_master --instance staginglb2
"

test_expect_success 'check_check_keepalived_vrrp w/ wildcard instance' "
    test_expect_code 0 $BASE/snmp/check_keepalived_vrrp -H test.mp.durchmesser.ch -P 1661 \
        -C keepalived_vrrp_master --instance stagingl*
"

test_expect_success 'check_check_keepalived_vrrp w/ unknown instance' "
